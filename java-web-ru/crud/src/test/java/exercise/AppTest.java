...
class AppTest {
    ...
    void testListArticles1() throws Exception {
        ...
        assertThat(body).contains("I Sing the Body Electric");
        assertThat(body).doesNotContain("Stranger in a Strange Land");
    ...
    void testListArticles2() throws Exception {
        ...
        assertThat(response.getStatus()).isEqualTo(200);
        assertThat(body).contains("Stranger in a Strange Land");
        assertThat(body).contains("Dying of the Light");
        assertThat(body).doesNotContain("I Sing the Body Electric");
        assertThat(body).doesNotContain("That Good Night");
    ...
    void testShowArticle() throws Exception {
        ...
        assertThat(response.getStatus()).isEqualTo(200);
        assertThat(body).contains("Ring of Bright Water");
        assertThat(body).contains("Iste veniam ullam rerum facere.");
    }
