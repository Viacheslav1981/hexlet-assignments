...
class ValidationTest {
    ...
    void testAdvancedValidate() throws IllegalAccessException {
        ...
        Map<String, List<String>> expected1 = Map.of("country",
                                              List.of("length less than 3"));
        assertThat(result1).isEqualTo(expected1);

        Address address2 = new Address("Ru", null, "Lenina", "54", null);
        Map<String, List<String>> result2 = Validator.advancedValidate(address2);
        Map<String, List<String>> expected2 = Map.of("country",
                List.of("length less than 3"),
